    ...
    <section id="contact" className="py-16 lg:py-24 bg-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <a
              ...
              className="bg-primary text-white px-8 py-3 rounded-lg font-semibold hover:bg-primary-dark transition-colors shadow-md hover:shadow-lg inline-flex items-center justify-center gap-2"
            ...
            <a
              ...
              download
              className="border-2 border-primary text-primary px-8 py-3 rounded-lg font-semibold hover:bg-primary/10 transition-colors inline-flex items-center justify-center gap-2"
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-background-light rounded-2xl shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-text-dark/80 mb-2">
                    Full Name *
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-colors"
                    placeholder="Your full name"
                  />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-text-dark/80 mb-2">
                    Email Address *
                  </label>
                  <input
                    type="email"
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-medium text-text-dark/80 mb-2">
                  Phone Number
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-text-dark/80 mb-2">
                  Message
                </label>
                <textarea
                  id="message"
              ...
              <button
                type="submit"
                className="w-full bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-dark transition-colors shadow-md hover:shadow-lg"
